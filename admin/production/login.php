...
<html lang="en">
  <head>
    ...
    <title>Yönetim Paneli! | KOÇDAĞ AVM </title>
        ...
        <div class="animate form login_form">
          <section class="login_content">
            <form action="../process/process.php" method="POST">
              <h1>Panel Giriş</h1>
              <div>
                <input type="text" class="form-control" placeholder="Kullanıcı Adınız" required="" name="users_mail" />
              </div>
              <div>
                <input type="password" class="form-control" placeholder="Şifreniz" required="" name="users_password" />
              </div>
              <div>
